...
export default class Item extends Component {
    constructor(props) {
        ...
        this.dragStartSetData = this.dragStartSetData.bind(this);
    }
    ...
    //pass the item's props to bubble up to the modal handler in Main
    itemClick() {
        this.props.passModal(this.props);
    }

    //set the item id to datatransfer
    dragStartSetData(e) {
    ...
    render() {
        ...
        return (
            <div className='Item' onClick={this.itemClick} draggable={true} onDrop={() => { return false; }} onDragStart={this.dragStartSetData}>
